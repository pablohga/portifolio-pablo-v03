...
/* console.log('setCurrentLanguage HERO!!!!', currentLanguage) */
  ...
  return (
  <section
    style={{ backgroundImage: `url(${theme === 'light' ? 'https://agenciaaimagic.com.br/portify/hero_img_clean-transformed_new1-light.png?v=2' : 'https://agenciaaimagic.com.br/portify/hero_img_clean-transformed_new1.png?v=2'})` }}
