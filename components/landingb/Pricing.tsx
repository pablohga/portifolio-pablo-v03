...
export function PricingB({ dark }: { dark?: boolean }) {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className={`inline-block px-4 py-1 rounded-full text-xs font-medium mb-4 border ${
            dark ? "bg-blue-500/10 border-blue-500/20 text-blue-400" : "bg-blue-50 border-blue-100 text-blue-600"
          }`}>
            Planos e Preços
          </div>
          <h2 className={`text-3xl md:text-4xl lg:text-5xl font-bold mb-4 ${
            ...
            Investimento <span className="text-blue-600">Transparente</span>
          </h2>
          ...
          {PLANS.map((plan, i) => (
            ...
            >
              ...
              <div className="text-center mb-8">
                <h3 className={`font-bold text-2xl mb-2 ${dark ? "text-white" : "text-slate-900"}`}>
                  {plan.name}
                </h3>
              ...
              <div className="text-center mb-8">
                <span className={`font-bold text-4xl ${dark ? "text-white" : "text-slate-900"}`}>
                  {plan.price}
                </span>
                <span className={`text-sm ml-1 ${dark ? "text-slate-400" : "text-slate-500"}`}>
                  {plan.period}
                </span>
              </div >
