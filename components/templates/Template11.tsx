...
export default function Template11({ userId, categories, projects, userImage, userName }: TemplateProps) {
  ...
  useEffect(() => {
    ...
    if (theme === 'dark') {
      ...
      document.documentElement.style.setProperty('--card2', '#1C1C1C');
      document.documentElement.style.setProperty('--teal', '#FFFFFF');
      document.documentElement.style.setProperty('--teal2', '#B0B0B0');
      document.documentElement.style.setProperty('--teal-dim', 'rgba(255,255,255,.08)');
      document.documentElement.style.setProperty('--teal-glow', 'rgba(255,255,255,.18)');
      document.documentElement.style.setProperty('--green', '#D0D0D0');
      document.documentElement.style.setProperty('--amber', '#D0D0D0');
      ...
      document.documentElement.style.setProperty('--bg3', '#EDEDED');
      document.documentElement.style.setProperty('--card', '#FFFFFF');
      document.documentElement.style.setProperty('--card2', '#F5F5F5');
      document.documentElement.style.setProperty('--teal', '#111111');
      document.documentElement.style.setProperty('--teal2', '#4A4A4A');
      document.documentElement.style.setProperty('--teal-dim', 'rgba(0,0,0,.06)');
      document.documentElement.style.setProperty('--teal-glow', 'rgba(0,0,0,.12)');
      document.documentElement.style.setProperty('--green', '#4A4A4A');
      document.documentElement.style.setProperty('--amber', '#4A4A4A');
  ...
  return (
    <div className="template-converted-wrapper" data-theme={theme}>
      <style dangerouslySetInnerHTML={{
        ...
        :root {
          --cyan: #D0D0D0;
          --cyan-soft: rgba(255,255,255,0.08);
          --cyan-mid: rgba(255,255,255,0.18);
          --dark-bg: #0A0A0A;
          --dark-surface: #111111;
          --dark-card: #1A1A1A;
          ...
          --text-secondary-dark: rgba(176,176,176,0.85);
          --text-primary-light: #111111;
          --text-secondary-light: rgba(70,70,70,0.75);
          --accent: #D3D3D3;
          --accent2: #B0B0B0;
          --success: #D0D0D0;
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-name span { color: var(--accent); text-shadow: 1px 1px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000; }
        ...
        .hero-photo-tag2 span { font-size: 0.78rem; font-weight: 700; color: #0A0A0A; font-family: var(--font-display); }
        ...
        .section-title em { font-style: normal; color: var(--accent); text-shadow: 1px 1px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000; }
        ...
        .portfolio-thumb-placeholder {
          width: 100%;
          aspect-ratio: 16/9;
          background: linear-gradient(135deg, var(--cyan-soft) 0%, rgba(176,176,176,0.15) 100%);
          display: flex; align-items: center; justify-content: center;
          font-size: 2.5rem;
        }
        ...
        .testimonial-card:hover { border-color: rgba(255,255,255,0.2); transform: translateY(-3px); }
        ...
        .contact-title em { font-style: normal; color: var(--accent); text-shadow: 1px 1px 0 #000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000; }
        ...
        .project-modal-close:hover { background: var(--accent); color: #0A0A0A; }
                  ...
                  <div className="highlight-text">
                    ...
                    <div
                      ...
                      dangerouslySetInnerHTML={{
                        __html: truncateWords(feature.description, 80).isLong
                          ? truncateWords(feature.description, 80).truncated
                          : DOMPurify.sanitize(feature.description)
                      }}
                    />
                    {truncateWords(feature.description, 80).isLong && (
                      <button
    ...
    {selectedFeature && (
      <div className="project-modal-overlay" onClick={() => setSelectedFeature(null)}>
        <div className="project-modal-content" onClick={e => e.stopPropagation()}>
          <button className="project-modal-close" onClick={() => setSelectedFeature(null)}>✕</button>
          <div className="project-modal-info">
            <h3 className="project-modal-title">{selectedFeature.title}</h3>
            <div className="project-modal-desc">
