...
export default function Template7({ userId, categories, projects, userImage, userName }: TemplateProps) {
  ...
  return (
    <>
      <div className="template-7-wrapper">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        :root {
          ...
          --olive2:  #ffcad6;
          --olive3:  #ffdce4;
          --oliveL:  rgba(255, 184, 201, .08);
          --oliveG:  rgba(255, 184, 201, .18);
          --dark:    #4a3a3d;
          --dark2:   #6b5b5e;
          --dark3:   #8c7c7e;
          --text:    #4a3a3d;
          --muted:   #8c7c7e;
          --border:  rgba(255, 184, 201, .25);
          --r:       10px;
          --r2:      18px;
          --r3:      28px;
        }
        ...
        .template-7-wrapper *, .template-7-wrapper *::before, .template-7-wrapper *::after { box-sizing: border-box; margin: 0; padding: 0 }
        .template-7-wrapper html { scroll-behavior: smooth }
        .template-7-wrapper .container { max-width: 1060px; margin: 0 auto; padding: 0 28px }
        .template-7-wrapper .olive { color: var(--olive) }
        .template-7-wrapper .muted { color: var(--muted) }

        .template-7-wrapper .badge {
        ...
        .template-7-wrapper .badge::before { content: '◆'; font-size: .6rem }

        .template-7-wrapper .btn-primary {
        ...
        .template-7-wrapper .btn-primary:hover { background: var(--olive2); transform: translateY(-2px); box-shadow: 0 8px 28px rgba(46,93,58,.4) }

        .template-7-wrapper .btn-outline {
          display: inline-flex; align-items: center; gap: 8px;
        ...
        .template-7-wrapper .btn-outline:hover { background: var(--oliveL) }

        .template-7-wrapper .section-title {
          font-family: 'Berkshire Swash', 'Playfair Display', serif;
          font-size: clamp(1.8rem, 3.5vw, 2.7rem);
          font-weight: 700; line-height: 1.2;
          letter-spacing: -.01em;
        }
        .template-7-wrapper .section-sub {
          font-size: 1rem; 
          color: var(--muted);
          /* max-width: 580px;  */
          margin-top: 12px; 
        ...
        .template-7-wrapper nav .container { display: flex; align-items: center; justify-content: space-between; gap: 20px }
        .template-7-wrapper .nav-links { display: flex; align-items: center; gap: 28px; list-style: none }
        .template-7-wrapper .nav-links a {
          text-decoration: none; font-size: .88rem;
          font-weight: 600; color: var(--text);
          transition: color .18s;
        }
        .template-7-wrapper .nav-links a:hover { color: var(--olive) }
        .template-7-wrapper .nav-cta { padding: 10px 22px; font-size: .84rem }

        .template-7-wrapper #hero {
          background: var(--cream);
          padding: 80px 0 0;
          overflow: hidden;
          position: relative;
        }
        .template-7-wrapper #hero::before {
        ...
        .template-7-wrapper .hero-copy { padding-bottom: 80px }
        .template-7-wrapper .hero-copy h1 {
          font-family: 'Berkshire Swash', 'Playfair Display', serif;
          font-size: clamp(2.1rem, 4.2vw, 3.4rem);
          font-weight: 700; line-height: 1.1;
          margin-bottom: 20px;
        }
        .template-7-wrapper .hero-copy h1 em {
          font-style: normal;
          color: var(--olive);
        }
        .template-7-wrapper .hero-copy p {
          font-size: 1.02rem; color: var(--muted);
          margin-bottom: 32px; max-width: 480px; line-height: 1.75;
        }
        .template-7-wrapper .hero-btns { display: flex; gap: 14px; flex-wrap: wrap }
        .template-7-wrapper .hero-img-wrap {
          position: relative; 
          /* align-self: flex-end; */
          display: flex; 
          justify-content: flex-end;
        }
        .template-7-wrapper .hero-img-box {
          position: relative;
          width: 100%;
        }
        .template-7-wrapper .hero-img-box::before {
          content: ''; position: absolute;
          inset: 0;
        ...
        .template-7-wrapper .hero-img-box img {
          width: 100%; 
          height: 100%; 
          object-fit: cover;
          object-position: top;
        ...
        .template-7-wrapper .hero-chip.c1 { top: 28px; left: -28px }
        .template-7-wrapper .hero-chip.c2 { bottom: 32px; left: -20px }
        .template-7-wrapper .chip-icon {
          width: 34px; height: 34px; border-radius: 8px;
          background: var(--oliveL);
          display: flex; align-items: center; justify-content: center;
          font-size: 1rem; flex-shrink: 0;
        }
        .template-7-wrapper .hero-stripe {
          background: var(--dark);
          margin-top: 0;
          padding: 16px 0;
        }
        .template-7-wrapper .stripe-inner {
          display: flex; align-items: center; justify-content: center;
          gap: 40px; flex-wrap: wrap;
        }
        .template-7-wrapper .stripe-item {
          display: flex; align-items: center; gap: 10px;
          font-size: .82rem; color: rgba(255,255,255,.55);
          white-space: nowrap;
        }
        .template-7-wrapper .stripe-dot { width: 6px; height: 6px; border-radius: 50%; background: var(--olive3); flex-shrink: 0 }

        .template-7-wrapper #about {
          padding: 96px 0;
          background: var(--white);
        }
        .template-7-wrapper .about-grid {
          display: grid; 
          grid-template-columns: 1fr 1.1fr;
          gap: 64px; 
          align-items: start;
        }
        .template-7-wrapper .about-img-wrap { position: relative }
        .template-7-wrapper .about-img-card {
          background: var(--cream);
          border-radius: var(--r3);
          overflow: hidden;
          position: relative;
        }
        .template-7-wrapper .about-img-card img {
          width: 100%; object-fit: cover;
          object-position: top center;
          max-height: 520px; display: block;
        }
        .template-7-wrapper .about-name-tag {
        ...
        .template-7-wrapper .about-name-tag strong { color: #fff; font-size: .95rem; font-weight: 700 }
        .template-7-wrapper .about-name-tag span { font-size: .78rem; color: rgba(255,255,255,.6) }
        .template-7-wrapper .about-verified {
          background: var(--olive3);
          color: #fff; font-size: .7rem; font-weight: 700;
          padding: 4px 10px; border-radius: 999px; letter-spacing: .06em;
        }
        .template-7-wrapper .about-copy .section-title { margin-bottom: 14px }
        .template-7-wrapper .about-copy > p {
          font-size: .95rem; color: var(--muted);
          margin-bottom: 28px; line-height: 1.8;
        }
        .template-7-wrapper .check-list { list-style: none; display: flex; flex-direction: column; gap: 13px; margin-bottom: 28px }
        .template-7-wrapper .check-list li {
          display: flex; align-items: flex-start; gap: 12px;
          font-size: .9rem; color: var(--text);
        }
        .template-7-wrapper .check-list .ck {
        ...
        .template-7-wrapper #services {
          padding: 96px 0;
          background: var(--dark);
        }
        .template-7-wrapper #services .badge {
          background: rgba(255,255,255,.07);
          border-color: rgba(255,255,255,.15);
          color: rgba(255,255,255,.7);
        }
        .template-7-wrapper #services .section-title { color: #fff }
        .template-7-wrapper #services .section-sub { color: rgba(255,255,255,.5); max-width: none }
        .template-7-wrapper .services-header {
          display: flex; align-items: flex-end; justify-content: space-between;
          gap: 24px; margin-bottom: 52px; flex-wrap: wrap;
        }
        .template-7-wrapper .services-grid {
          display: grid; grid-template-columns: repeat(2, 1fr);
          gap: 20px;
        }
        .template-7-wrapper .service-card {
        ...
        .template-7-wrapper .service-card::before {
          content: ''; position: absolute;
          top: 0; left: 0; right: 0; height: 2px;
          background: linear-gradient(90deg, var(--olive3), transparent);
          opacity: 0; transition: opacity .25s;
        }
        .template-7-wrapper .service-card:hover { border-color: rgba(78,150,99,.3); transform: translateY(-3px) }
        .template-7-wrapper .service-card:hover::before { opacity: 1 }
        .template-7-wrapper .service-icon {
          width: 48px; height: 48px; border-radius: 12px;
          background: var(--dark3);
          display: flex; align-items: center; justify-content: center;
          font-size: 1.4rem; margin-bottom: 18px;
        }
        .template-7-wrapper .service-card h4 {
          font-family: 'Playfair Display', serif;
          font-size: 1.1rem; font-weight: 700;
          color: #fff; margin-bottom: 10px;
        }
        .template-7-wrapper .service-card p { font-size: .84rem; color: rgba(255,255,255,.45); line-height: 1.7 }
        .template-7-wrapper .service-tag {
        ...
        .template-7-wrapper #process {
          padding: 96px 0;
          background: var(--cream2);
        }
        .template-7-wrapper #process .container { text-align: center }
        .template-7-wrapper .process-grid {
          display: grid; grid-template-columns: repeat(4, 1fr);
          gap: 0; margin-top: 52px; position: relative;
        }
        .template-7-wrapper .process-grid::before {
          content: ''; position: absolute;
        ...
        .template-7-wrapper .process-step {
          position: relative; z-index: 1;
          padding: 0 16px;
        }
        .template-7-wrapper .ps-num {
        ...
        .template-7-wrapper .process-step:hover .ps-num {
          background: var(--olive); color: #fff; border-color: var(--olive);
        }
        .template-7-wrapper .ps-icon { font-size: 1.1rem; margin-bottom: 10px }
        .template-7-wrapper .process-step h4 {
          font-family: 'Playfair Display', serif;
          font-size: .95rem; font-weight: 700; margin-bottom: 8px;
        }
        .template-7-wrapper .process-step p { font-size: .8rem; color: var(--muted); line-height: 1.65 }

        .template-7-wrapper #curriculum {
          padding: 96px 0;
          background: var(--dark);
        }
        .template-7-wrapper .cv-grid {
          display: grid; grid-template-columns: 1fr 1fr;
          gap: 24px;
        }
        .template-7-wrapper .cv-card {
          background: var(--dark2);
          border: 1px solid rgba(255,255,255,.07);
          border-radius: var(--r2);
          padding: 28px;
        }
        .template-7-wrapper .cv-card-title {
          display: flex; align-items: center; gap: 10px;
          margin-bottom: 22px;
        }
        .template-7-wrapper .cv-card-title .ico { font-size: 1.1rem }
        .template-7-wrapper .cv-card-title span {
          font-family: 'Playfair Display', serif;
          font-size: .95rem; font-weight: 700; color: #fff;
        }
        .template-7-wrapper .cv-item {
        ...
        .template-7-wrapper .cv-item:last-child { border-bottom: none }
        .template-7-wrapper .cv-item .ck { color: var(--olive3); flex-shrink: 0; margin-top: 1px }
        .template-7-wrapper .cv-item strong { color: rgba(255,255,255,.85); display: block }
S
        .template-7-wrapper .testimonial-grid {
          display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));
          gap: 24px;
        }
        .template-7-wrapper .testimonial-card {
          background: var(--white);
          border: 1px solid var(--border);
          border-radius: var(--r2);
          padding: 30px;
        ...
        .template-7-wrapper .testimonial-card:hover { transform: translateY(-4px); box-shadow: 0 12px 30px rgba(0,0,0,.05); border-color: var(--olive2); }
        .template-7-wrapper .testimonial-stars { color: #fbbf24; font-size: .9rem; margin-bottom: 16px; }
        .template-7-wrapper .testimonial-text {
          font-size: .95rem; color: var(--dark2);
          line-height: 1.7; margin-bottom: 24px;
          font-style: italic;
        }
        .template-7-wrapper .testimonial-author { display: flex; align-items: center; gap: 12px; }
        .template-7-wrapper .author-avatar {
          width: 44px; height: 44px; border-radius: 50%;
          background: var(--oliveL); overflow: hidden;
          flex-shrink: 0;
        }
        .template-7-wrapper .author-avatar img { width: 100%; height: 100%; object-fit: cover; }
        .template-7-wrapper .author-name { font-weight: 700; font-size: .9rem; color: var(--text); }
        .template-7-wrapper .author-role { font-size: .75rem; color: var(--muted); }

        .template-7-wrapper #howitworks {
          padding: 96px 0;
          background: var(--white);
        }
        .template-7-wrapper .hiw-grid {
          display: grid; grid-template-columns: 1fr 1fr;
          gap: 56px; align-items: center;
        }
        .template-7-wrapper .hiw-cards {
          display: grid; grid-template-columns: 1fr 1fr;
          gap: 16px;
        }
        .template-7-wrapper .hiw-card {
          background: var(--cream);
          border: 1px solid var(--border);
          border-radius: var(--r2);
          padding: 22px 18px;
        ...
        .template-7-wrapper .hiw-card:hover { border-color: var(--olive); background: var(--oliveL) }
        .template-7-wrapper .hiw-card .ico { font-size: 1.5rem; margin-bottom: 12px }
        .template-7-wrapper .hiw-card h5 {
          font-family: 'Playfair Display', serif;
          font-size: .9rem; font-weight: 700; margin-bottom: 6px;
        }
        .template-7-wrapper .hiw-card p { font-size: .78rem; color: var(--muted); line-height: 1.6 }
        .template-7-wrapper .hiw-card.accent {
          background: var(--olive); border-color: var(--olive);
          grid-column: span 2;
          display: flex; align-items: center; gap: 14px;
          padding: 18px 22px;
        }
        .template-7-wrapper .hiw-card.accent .ico { margin-bottom: 0; font-size: 1.6rem }
        .template-7-wrapper .hiw-card.accent h5 { color: #fff; margin-bottom: 2px }
        .template-7-wrapper .hiw-card.accent p { color: rgba(255,255,255,.7) }

        .template-7-wrapper #cta-banner {
          background: linear-gradient(135deg, var(--olive) 0%, var(--dark2) 100%);
          padding: 72px 0;
        }
        .template-7-wrapper .cta-inner {
          display: flex; align-items: center; justify-content: space-between;
          gap: 32px; flex-wrap: wrap;
        }
        .template-7-wrapper .cta-inner h2 {
          font-family: 'Berkshire Swash', 'Playfair Display', serif;
          font-size: clamp(1.7rem, 3vw, 2.4rem);
          font-weight: 700; color: #fff;
          max-width: 520px; line-height: 1.25;
        }
        .template-7-wrapper .cta-inner p {
          font-size: .95rem; color: rgba(255,255,255,.6);
          max-width: 440px; margin-top: 10px;
        }
        .template-7-wrapper .btn-white {
          display: inline-flex; align-items: center; gap: 8px;
        ...
        .template-7-wrapper .btn-white:hover { transform: translateY(-2px); box-shadow: 0 8px 32px rgba(0,0,0,.25) }

        .template-7-wrapper #contact {
          padding: 96px 0;
          background: var(--cream);
        }
        .template-7-wrapper .contact-grid {
          display: grid; 
          /* grid-template-columns: 1fr 1fr; */
          gap: 56px; align-items: center;
        }
        .template-7-wrapper .contact-info h2 { margin-bottom: 12px }
        .template-7-wrapper .contact-info .section-sub { margin-bottom: 36px }
        .template-7-wrapper .contact-items {
          display: flex; 
          flex-direction: row; 
          justify-content: center;
          gap: 18px;
        }
        .template-7-wrapper .contact-item {
        ...
        .template-7-wrapper .contact-item:hover { border-color: var(--olive) }
        .template-7-wrapper .contact-icon {
          width: 42px; height: 42px; flex-shrink: 0;
          background: var(--oliveL); border-radius: 10px;
          display: flex; align-items: center; justify-content: center;
          font-size: 1.1rem;
        }
        .template-7-wrapper .contact-item span { font-size: .84rem; font-weight: 700; display: block }
        .template-7-wrapper .contact-item small { font-size: .78rem; color: var(--muted) }

        .template-7-wrapper .chat-mock {
          background: var(--dark);
          border-radius: var(--r3);
          padding: 24px;
          box-shadow: 0 24px 64px rgba(0,0,0,.2);
        }
        .template-7-wrapper .chat-header {
          display: flex; align-items: center; gap: 12px;
          margin-bottom: 20px;
          padding-bottom: 16px;
          border-bottom: 1px solid rgba(255,255,255,.07);
        }
        .template-7-wrapper .chat-avatar {
          width: 40px; height: 40px; border-radius: 50%;
          background: var(--olive2);
          display: flex; align-items: center; justify-content: center;
          font-size: 1rem; flex-shrink: 0; overflow: hidden;
        }
        .template-7-wrapper .chat-avatar img { width: 100%; height: 100%; object-fit: cover; object-position: top }
        .template-7-wrapper .chat-hname { font-size: .9rem; font-weight: 700; color: #fff }
        .template-7-wrapper .chat-hstatus { font-size: .72rem; color: var(--olive3); display: flex; align-items: center; gap: 5px }
        .template-7-wrapper .chat-hstatus::before { content: '●' }
        .template-7-wrapper .chat-msgs { display: flex; flex-direction: column; gap: 12px }
        .template-7-wrapper .msg { max-width: 80%; border-radius: 16px; padding: 11px 15px; font-size: .82rem; line-height: 1.6 }
        .template-7-wrapper .msg.in {
          background: var(--dark2);
          color: rgba(255,255,255,.75);
          border-bottom-left-radius: 4px; align-self: flex-start;
        }
        .template-7-wrapper .msg.out {
          background: var(--olive);
          color: #fff;
          border-bottom-right-radius: 4px; align-self: flex-end;
        }
        .template-7-wrapper .msg-time { font-size: .68rem; color: rgba(255,255,255,.3); margin-top: 4px; text-align: right }
        .template-7-wrapper .chat-input {
          display: flex; align-items: center; gap: 10px;
          margin-top: 18px;
          background: var(--dark2);
          border-radius: 12px; padding: 10px 14px;
        }
        .template-7-wrapper .chat-input span { flex: 1; font-size: .8rem; color: rgba(255,255,255,.25) }
        .template-7-wrapper .send-btn {
        ...
        .template-7-wrapper footer {
          background: var(--dark);
          border-top: 1px solid rgba(255,255,255,.06);
          padding: 52px 0 28px;
        }
        .template-7-wrapper #contact-form-wrapper { 
          padding: 8px 
        }
        .template-7-wrapper #contact-form-wrapper input{ 
          padding: 8px 
        }
        .template-7-wrapper #contact-form-wrapper textarea{ 
          padding: 8px 
        }

        /* ProjectsSection Overrides for Template 7 */
        .template-7-wrapper #projects {
          background: var(--cream) !important;
          color: var(--text) !important;
          padding: 96px 0 !important;
          border: none !important;
        }
        .template-7-wrapper #projects h2 {
          font-family: 'Berkshire Swash', 'Playfair Display', serif;
          color: var(--text) !important;
          text-align: center !important;
        }
        .template-7-wrapper #tab-list {
          display: flex;
          align-items: center;
          justify-content: center;
          gap: 12px;
        ...
        .template-7-wrapper #tab-list button{
        /* display: flex; align-items: center; justify-content: center; gap: 12px; */
        padding: 12px 18px !important;
        }
        .template-7-wrapper #projects p {
          color: var(--muted) !important;
          font-family: 'Nunito Sans', sans-serif !important;
          text-align: center !important;
        }
        .template-7-wrapper #projects [role="tablist"] {
        ...
        .template-7-wrapper #projects [role="tab"][data-state="active"] {
          background: var(--olive) !important;
          color: #fff !important;
        }
        .template-7-wrapper #projects [role="tab"] {
          color: var(--muted) !important;
        }
        .template-7-wrapper #projects .group {
        ...
        .template-7-wrapper #projects .group:hover {
          /* border-color: var(--olive) !important; */
          box-shadow: 0 8px 24px rgba(46,93,58,.1) !important;
        }
        .template-7-wrapper #projects .group h3 {
          color: var(--text) !important;
          font-family: 'Playfair Display', serif !important;
        }
        .template-7-wrapper #projects .group h3:hover {
          color: var(--olive) !important;
        }
        .template-7-wrapper #projects .group span {
        ...
        .template-7-wrapper #projects button:disabled {
          opacity: 0.5;
          cursor: not-allowed;
        }
        .template-7-wrapper #projects .p-10 {
          background: var(--white);
          margin-top: 10px;
          padding: 10px;
        }
        .template-7-wrapper #projects .text-muted-foreground {
          margin-top: 10px;
        }
        .template-7-wrapper #projects .flex-wrap {
          margin-top: 10px;
        }
        .template-7-wrapper #projects .rounded-full.w-10.h-10 {
          background: var(--white) !important;
          /* border: 1px solid var(--border) !important; */
          color: var(--olive) !important;
        }
        .template-7-wrapper .footer-top {
          display: flex; align-items: flex-start; justify-content: space-between;
          gap: 40px; flex-wrap: wrap; margin-bottom: 40px;
        }
        .template-7-wrapper .footer-brand p { font-size: .82rem; color: rgba(255,255,255,.35); max-width: 260px; line-height: 1.7 }
        .template-7-wrapper .footer-links h5 {
          font-size: .75rem; font-weight: 700; letter-spacing: .12em;
          text-transform: uppercase; color: rgba(255,255,255,.4);
          margin-bottom: 16px;
        }
        .template-7-wrapper .footer-links a {
          display: block; text-decoration: none;
          font-size: .84rem; color: rgba(255,255,255,.45);
          margin-bottom: 9px; transition: color .18s;
        }
        .template-7-wrapper .footer-links a:hover { color: #fff }
        .template-7-wrapper .footer-bottom {
          border-top: 1px solid rgba(255,255,255,.06);
          padding-top: 22px;
          display: flex; align-items: center; justify-content: space-between;
        ...
        .template-7-wrapper .reveal { opacity: 0; transform: translateY(24px); transition: opacity .6s ease, transform .6s ease }
        .template-7-wrapper .reveal.visible { opacity: 1; transform: none }
        .template-7-wrapper .reveal-l { opacity: 0; transform: translateX(-24px); transition: opacity .6s ease, transform .6s ease }
        .template-7-wrapper .reveal-l.visible { opacity: 1; transform: none }
        .template-7-wrapper .reveal-r { opacity: 0; transform: translateX(24px); transition: opacity .6s ease, transform .6s ease }
        .template-7-wrapper .reveal-r.visible { opacity: 1; transform: none }

        @media(max-width:900px) {
          .template-7-wrapper .hero-grid, .template-7-wrapper .about-grid, .template-7-wrapper .hiw-grid, .template-7-wrapper .contact-grid { grid-template-columns: 1fr }
          .template-7-wrapper .services-grid { grid-template-columns: 1fr }
          .template-7-wrapper .process-grid { grid-template-columns: 1fr 1fr; gap: 32px }
          .template-7-wrapper .process-grid::before { display: none }
          .template-7-wrapper .cv-grid { grid-template-columns: 1fr }
          .template-7-wrapper .hero-img-box { max-width: 100% }
          .template-7-wrapper .hero-chip.c1, .template-7-wrapper .hero-chip.c2 { display: none }
          .template-7-wrapper .footer-top { flex-direction: column }
          .template-7-wrapper .cta-inner { flex-direction: column }
          .template-7-wrapper nav .nav-links { display: none }
        }
        @media(max-width:560px) {
          .template-7-wrapper .process-grid { grid-template-columns: 1fr }
          .template-7-wrapper .hiw-cards { grid-template-columns: 1fr }
          .template-7-wrapper .hiw-card.accent { grid-column: span 1 }
          .template-7-wrapper .hero-copy { padding-bottom: 40px }
        }
      ` }} />
