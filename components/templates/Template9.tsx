...
export default function Template9({ userId, categories, projects, userImage, userName }: TemplateProps) {
  ...
  return (
    <div className="template-converted-wrapper" data-theme={theme}>
      <style dangerouslySetInnerHTML={{
        ...
        :root {
          --cyan: #663464;
          --cyan-soft: rgba(102, 52, 100, 0.12);
          --cyan-mid: rgba(102, 52, 100, 0.25);
          --dark-bg: #260025;
          --dark-surface: #360d35;
          --dark-card: #461a44;
          --dark-border: rgba(102, 52, 100, 0.18);
          --light-bg: #fdfbfd;
          --light-surface: #ffffff;
          --light-card: #f8f3f8;
          --light-border: rgba(102, 52, 100, 0.1);
          ...
          --radius-lg: 22px;
          --radius-xl: 32px;
          --shadow-glow: 0 0 40px rgba(102, 52, 100, 0.15);
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-hire:hover {
          ...
          box-shadow: 0 8px 24px rgba(102, 52, 100, 0.3);
        }
        ...
        .hero-glow {
          ...
          border-radius: 50%;
          background: radial-gradient(circle, rgba(102, 52, 100, 0.12) 0%, transparent 70%);
        ...
        .hero-badge {
          ...
          border: 1px solid rgba(102, 52, 100, 0.3);
          color: var(--accent);
          font-family: var(--font-display);
          font-size: 0.72rem;
          font-weight: 700;
        ...
        .btn-primary:hover {
          ...
          box-shadow: 0 12px 32px rgba(102, 52, 100, 0.35);
        }
        ...
        .hero-photo-ring {
          ...
          border: 1.5px solid rgba(102, 52, 100, 0.25);
        ...
        .service-card:hover {
          border-color: rgba(102, 52, 100, 0.3);
        ...
        .portfolio-thumb-placeholder {
          width: 100%;
          aspect-ratio: 16/9;
          background: linear-gradient(135deg, var(--cyan-soft) 0%, rgba(86, 39, 84, 0.15) 100%);
          display: flex; align-items: center; justify-content: center;
          font-size: 2.5rem;
        }
        ...
        .portfolio-overlay {
          position: absolute; inset: 0;
          background: rgba(102, 52, 100, 0.08);
          opacity: 0;
        ...
        .testimonial-card:hover { border-color: rgba(102, 52, 100, 0.25); transform: translateY(-3px); }
        ...
        .about-image-overlay {
          position: absolute; inset: 0;
          background: linear-gradient(135deg, rgba(102, 52, 100, 0.15) 0%, transparent 60%);
          border-radius: var(--radius-xl);
        }
        ...
        .contact-section::before {
          ...
          border-radius: 50%;
          background: radial-gradient(circle, rgba(102, 52, 100, 0.08) 0%, transparent 70%);
          top: 50%; left: 50%;
        ...
        .project-modal-content {
          ...
          box-shadow: 0 0 50px rgba(102, 52, 100, 0.2);
        }
